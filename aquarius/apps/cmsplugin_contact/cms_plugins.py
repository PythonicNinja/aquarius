...
class ContactPlugin(CMSPluginBase):
    ...
    fieldsets = (
        (None, {
            'fields': ('site_email', 'email_label', 'name_label',
                       'phone_label','content_label', 'thanks', 'submit'),
        }),
        (_('Spam Protection'), {
    ...
    def render(self, context, instance, placeholder):
        ...
        form.fields['name'].widget.attrs['placeholder'] = instance.name_label
        form.fields['email'].widget.attrs['placeholder'] = instance.email_label
        form.fields['phone'].widget.attrs['placeholder'] = instance.phone_label
        form.fields['content'].widget.attrs['placeholder'] = instance.content_label
